...
# the dataset used is the manually classified face16
...
# model.load_weights("adversary_gen_overall_16.h5")
...
callbacks = [
    ...
    ModelCheckpoint(filepath="adversary_16_gen_checkpoint.h5py",
                    monitor='val_acc',
                    save_best_only=True,
                    verbose=1)
]

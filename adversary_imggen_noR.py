...
# model.load_weights("adversary_imggen_noR_overall.h5")
...
callbacks = [
    ...
    ModelCheckpoint(filepath="adversary_imggen_noR_checkpoint.h5py",
                    monitor='val_acc',
                    save_best_only=True,
                    verbose=1)
]
...
model.save_weights("adversary_imggen_noR_overall.h5")
